    ...
    buildSaveData() {
        ...
        const shaftsData = mineshafts.map(s => ({
            ...
            managerAbility: s.managerAbility ? {
                type: s.managerAbility.type || 'discount',
                name: s.managerAbility.name || 'Unknown',
                desc: s.managerAbility.desc || '',
                icon: s.managerAbility.icon || '$',
                effect: s.managerAbility.effect !== undefined ? s.managerAbility.effect : 0.3,
                isMega: s.managerAbility.isMega || false,
                special: s.managerAbility.special || null,
                activeUntil: s.managerAbility.activeUntil || 0,
                cooldownUntil: s.managerAbility.cooldownUntil || 0,
        ...
        return {
            ...
            elevatorManagerAbility: elevatorManagerAbility ? {
                type: elevatorManagerAbility.type || 'discount',
                name: elevatorManagerAbility.name || 'Unknown',
                desc: elevatorManagerAbility.desc || '',
                icon: elevatorManagerAbility.icon || '$',
                effect: elevatorManagerAbility.effect !== undefined ? elevatorManagerAbility.effect : 0.3,
                isMega: elevatorManagerAbility.isMega || false,
                special: elevatorManagerAbility.special || null,
                activeUntil: elevatorManagerAbility.activeUntil || 0,
                cooldownUntil: elevatorManagerAbility.cooldownUntil || 0,
